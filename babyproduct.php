...
// 1. Fetch Products for Baby Category
$result = $conn->query("SELECT * FROM products WHERE category = 'baby'");
$dynamic_html = "";
...
if ($result && $result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
      ...
      if ($isSoldOut) {
           ...
           $btnText = "Sold Out";
           // Add onclick="handleSoldOut()" to trigger the function
