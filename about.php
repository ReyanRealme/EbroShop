...
<nav style="position: fixed; bottom: 0; left: 0; width: 100%; height: 65px; background-color: #ffffff; display: flex; align-items: center; justify-content: space-around; border-top: 1px solid #e5e5e5; z-index: 999999; backface-visibility: hidden; -webkit-backface-visibility: hidden; transform: translateZ(0); will-change: transform; box-sizing: border-box; padding: 0; margin: 0;">
    
    <a href="./home.html" style="display: flex; flex-direction: column; align-items: center; text-decoration: none; color: #1a1a1a; flex: 1; -webkit-tap-highlight-color: transparent;">
        <i class="ri-home-3-line" style="font-size: 24px; margin: 0; padding: 0; line-height: 1;"></i>
        <span style="font-size: 12px; margin-top: 4px; font-weight: 500; font-family: sans-serif;">Home</span>
    </a>
    
    <a href="./search.html" style="display: flex; flex-direction: column; align-items: center; text-decoration: none; color: #1a1a1a; flex: 1; -webkit-tap-highlight-color: transparent;">
        <i class="ri-search-line" style="font-size: 24px; margin: 0; padding: 0; line-height: 1;"></i>
        <span style="font-size: 12px; margin-top: 4px; font-weight: 500; font-family: sans-serif;">Search</span>
    </a>

    <a href="./collection.html" style="display: flex; flex-direction: column; align-items: center; text-decoration: none; color: #1a1a1a; flex: 1; -webkit-tap-highlight-color: transparent;">
        <i class="ri-grid-line" style="font-size: 24px; margin: 0; padding: 0; line-height: 1;"></i>
        <span style="font-size: 12px; margin-top: 4px; font-weight: 500; font-family: sans-serif;">Collection</span>
    </a>

    <a href="./login.html" style="display: flex; flex-direction: column; align-items: center; text-decoration: none; color: #1a1a1a; flex: 1; -webkit-tap-highlight-color: transparent;">
        <i class="ri-user-line" style="font-size: 24px; margin: 0; padding: 0; line-height: 1;"></i>
        <span style="font-size: 12px; margin-top: 4px; font-weight: 500; font-family: sans-serif;">Account</span>
    </a>

    <a href="./Cart.html" style="display: flex; flex-direction: column; align-items: center; text-decoration: none; color: #1a1a1a; flex: 1; -webkit-tap-highlight-color: transparent;">
        <div style="position: relative; display: flex; flex-direction: column; align-items: center;">
            <i class="ri-shopping-bag-line" style="font-size: 24px; margin: 0; padding: 0; line-height: 1;"></i>
            <span id="cart-num" style="position: absolute; top: -6px; right: -12px; background: #000000; color: #ffffff; font-size: 10px; width: 18px; height: 18px; border-radius: 50%; display: flex; justify-content: center; align-items: center; font-weight: bold; font-family: sans-serif;">0</span>
        </div>
        <span style="font-size: 12px; margin-top: 4px; font-weight: 500; font-family: sans-serif;">Cart</span>
    </a>
</nav>
...
(function(){
  ...
  updateBadge();
  // Logic to update the cart number
    function updateCartDisplay(count) {
        const cartBadge = document.getElementById('cart-num');
        if(cartBadge) {
